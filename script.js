...
function tellMe(joke){
    ...
    VoiceRSS.speech({
        key: '93658900ebba45dcb193218f9f8e60f5',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: -1, 
...
async function getJokes(){
    ...
    const apiUrl = 'https://v2.jokeapi.dev/joke/Miscellaneous,Dark,Pun?blacklistFlags=racist,sexist,explicit';
    try{
